...
if __name__ == '__main__':
    ...
    build_molecule('fragments.sdf', 'fragments.txt', 'frequencies.txt', 'isoxazole-13.sdf', 'isoxazole-13.sdf', [13], [100], {5:2}, outfile_name, 100, filters=True, unique=True, figure='fig.sdf')
